...
問題がなければこのまま進め、もし機能が有効化できない／うまく動かない場合は、「[7. WSL 導入時のトラブルと対処法](#7-wsl-導入時のトラブルと対処法)」を参考にしてください。
...
- 対処法:
  ...
  1. 機能の再有効化:
    [4.2](#42-機能の無効化とリセット手順), [4.3](#43-powershell-による機能有効化) の手順に従い、機能を再度、有効にします。
